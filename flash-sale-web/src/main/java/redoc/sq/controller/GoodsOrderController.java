...
import redoc.sq.convertor.GoodsOrderConvertor;
...
public class GoodsOrderController {
    ...
    public ResultDTO<GoodsOrderDTO> get(@PathVariable final String id) {
    ...
    public ResultDTO<GoodsOrderDTO> update(@PathVariable final String id, @RequestBody @Valid final GoodsOrderDTO goodsOrderDTO) {
