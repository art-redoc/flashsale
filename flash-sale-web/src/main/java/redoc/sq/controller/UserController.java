...
import redoc.sq.convertor.UserConvertor;
...
public class UserController {
    ...
    public ResultDTO<UserDTO> get(@PathVariable final String id) {
    ...
    public ResultDTO<UserDTO> update(@PathVariable final String id, @RequestBody @Valid final UserDTO userDTO) {
        userDTO.setId(id);
        final User model = this.userConvertor.toModel(userDTO);
